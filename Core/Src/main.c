...
const unsigned long period_us = 1000000/BAUD; // period in microseconds
const unsigned long delay_instr = period_us * 200; // one microsecond takes about 200 instructions
